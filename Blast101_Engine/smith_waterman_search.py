print("########################################################################")
print("#         Search using SW                                              #")
print("#         Super SLOW compared to Blast                                 #")
print("########################################################################")
...
aligntime = 0
max_scores = args.max_sw_scores

query_sequence = args.query.upper()
database = args.db
...
def smith_run():
    ...
    with open(r"logs\SWsearch.csv", 'w') as outputfile:
